# Generated by Powerlevel10k configuration wizard on 2020-06-25 at 14:07 JST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 22558.
# Wizard options: compatible, lean, 2 lines, disconnected, compact, fluent,
# instant_prompt=off.
...
() {
  ...
  # No line terminator if prompt_char is the last segment.Style/FrozenStringLiteralComment:
